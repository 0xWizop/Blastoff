    ...
    <html lang="en">
      <body className="relative min-h-screen bg-blastoff-bg font-body text-blastoff-text antialiased">
        <Toaster
          ...
          icons={{
            success: (
              <svg className="h-5 w-5 text-blastoff-orange" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
            ),
            error: (
              <svg className="h-5 w-5 text-blastoff-error" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            warning: (
              <svg className="h-5 w-5 text-blastoff-warning" fill="none" viewBox="0 0 24 24" stroke="currentColor">
