...
export function Footer() {
  ...
  const socials = [
    { key: 'website', label: 'Website', href: process.env.NEXT_PUBLIC_WEBSITE_URL },
    { key: 'twitter', label: 'Twitter', href: process.env.NEXT_PUBLIC_TWITTER_URL },
    { key: 'telegram', label: 'Telegram', href: process.env.NEXT_PUBLIC_TELEGRAM_URL },
    { key: 'discord', label: 'Discord', href: process.env.NEXT_PUBLIC_DISCORD_URL },
  ] as const;
